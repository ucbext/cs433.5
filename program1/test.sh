...
source $(rlocation devops/thirdparty/shell/unittest.bash)

info_path=$(rlocation devops/program1/info.sh)
sum_path=$(rlocation devops/program1/sum.sh)
seq_path=$(rlocation devops/program1/seq.sh)
stdio_path=$(rlocation devops/program1/stdio.sh)
